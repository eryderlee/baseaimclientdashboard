...
export default function DashboardPage() {
  ...
  // Use shared utility for consistent progress calculation
  ...
  const workflowHighlights = [
    {
      ...
      detail: recentMilestone
        ? `${recentMilestone.status.replace("_", " ")} · Due ${recentMilestone.dueDate.toLocaleDateString()}`
        : "Awaiting kickoff",
    ...
    },
    {
      ...
      detail: nextMilestone
        ? `Begins after ${nextMilestone.dueDate.toLocaleDateString()}`
